...
def fit_one_epoch(net,yolo_loss,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    if epoch%9 == 0:
        torch.save(model.state_dict(), '/mnt/disk/zhh/yolov4-pytorch/logs/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_loss/(epoch_size_val+1)))
...
if __name__ == "__main__":
    ...
    #----------------------------------------------------#
    anchors_path = '/mnt/disk/zhh/yolov4-pytorch/model_data/yolo_anchors.txt'
    classes_path = '/mnt/disk/zhh/yolov4-pytorch/model_data/voc_classes.txt'   
    #------------------------------------------------------#
    #   Yolov4的tricks应用
    ...
    #   权值文件请看README，百度网盘下载
    #------------------------------------------------------#
    model_path = "/mnt/disk/zhh/yolov4-pytorch/model_data/yolo4_voc_weights.pth"
    ...
    loss_history = LossHistory("/mnt/disk/zhh/yolov4-pytorch/logs/")

    #----------------------------------------------------#
    #   获得图片路径和标签
    #----------------------------------------------------#
    annotation_path = '/mnt/disk/zhh/yolov4-pytorch/2007_train.txt'
    #----------------------------------------------------------------------#
